<div class="container" id="contact">
  ...
  <div class="row">
    <div class="col-xs-10 col-xs-push-1 col-sm-8 col-sm-push-2">
      <div class="form" id="">
        <form action="<?= base_url ?>index.php?controller=parte&action=buscarPartes" method="post">
          ...
          <div class="form-group">
            ...
            <input type="date" class="form-control" placeholder="Fecha accidente" name="fecha_accidente" 
              autofocus>
          </div>
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="causa_accidente" placeholder="100 caracteres máximo" rows="3"
              maxlength="100"  style="max-width: 100%"></textarea>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="partes_cuerpo_lesionado" placeholder="60 caracteres máximo" rows="3"
              maxlength="60"  style="max-width: 100%"></textarea>
          </div>
