        <div class="container">
          ...
          <div class="row pt-2 mt-4 centrado">
            <div class="col-lg-8 ">
              <h2 class="text-align-center sin-fondo">Bajadas de bandera</h2>
            </div>
          </div>
            ...
            <div class="col col-md-10  col-lg-8   pt-2">
              <form action="#" onsubmit="return modal1()" method="post">
                ...
                <div class="form-group col-12 col-md-6 col-lg-6">
                  <label for="">Bajadas de bandera Fin Jornada</label>
                  <input type="number" class="form-control" placeholder="sólo números enteros" name="viajesFinJornada" id="viajesFinJornada" required="required" autofocus="autofocus">
                </div>

                <div class="form-group col-12 col-md-6 col-lg-6">
                  <label for="">Bajadas de bandera Inicio Jornada</label>
                  <input type="number" class="form-control" placeholder="sólo números enteros" name="viajesInicioJornada" id="viajesInicioJornada" required="required" >
                </div>

                <div class="form-row centrado">
                  <div class="col-4 col-lg-6  pt-3 mt-3 mb-5">
                    <button type="submit" class="btn btn-blue btn-block">Añadir Viajes</button>
                  </div>
                </div>
          ...
          <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="modalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <form class="" action="<?=base_url?>index.php?controller=hojaDiaria&action=addViajes"  method="post">
                  <div class="modal-body centrado">
                    <label for="">Bajadas de bandera Inicio Jornada</label>
                    <input type="text" class="text-align-center ml-2" name="" id="codigo" value="" size="8"  readonly>
                    <input type="hidden" name="viajesFinJornada" value="" id="codigo1">
                  </div>
                  <div class="modal-body centrado">
                    <label for="">Bajadas de bandera Fin Jornada</label>
                    <input type="text" class="text-align-center ml-2" name="" id="codigo2" value="" size="8"  readonly>
                    <input type="hidden" name="viajesInicioJornada" value="" id="codigo3">
                  </div>
          ...
          <!-- /Modal -->
                ...
                function modal1() {
                  ...
                  var importe = document.getElementById("viajesFinJornada").value;
                  ...
                  importe = document.getElementById("viajesInicioJornada").value;
          ...
          //Modal con el importe para poder verificar antes de enviar
                  $('#modal1').modal('show');
                  var valor = document.getElementById("viajesFinJornada").value;
                  document.getElementById("codigo").value=valor;
                  document.getElementById("codigo1").value=valor;

                  var valor1 = document.getElementById("viajesInicioJornada").value;
