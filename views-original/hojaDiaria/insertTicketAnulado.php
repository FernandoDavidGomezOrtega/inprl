<div class="row pt-2 mt-4 centrado">
  <div class="col-lg-8 ">
    <h2 class="text-align-center sin-fondo">Ticket anulado</h2>
  </div>
</div>
...
<?php if(isset($_SESSION['ticketAnulado'])) :  ?>
    <div class="row centrado">
      <div class="alert alert-success text-align-center" role="alert">
        ...
        <h6 class="text-align-center sin-fondo">Importe: <b><?= $_SESSION['ticketAnulado']?></b> €</h6>
      </div>
    </div>
<?php Utils::deleteSession('ticketAnulado'); endif; ?>
  ...
  <div class="col col-md-10  col-lg-6   pt-2">
    <form action="#" onsubmit="return modal1()" method="post">
      ...
      <div class="form-group col-12 col-md-6 col-lg-6  ">
        ...
        <input type="number" step="0.01" class="form-control " maxlength="10" placeholder="" name="ticketAnulado" id="ticketAnulado" required="required" autofocus="autofocus">
      </div>

      <div class="form-row col-lg-12 ">
        <div class="col  pb-5 pt-5 centrado ">
          <button type="submit" class="btn btn-blue col-lg-5 mr-lg-4  "    >Añadir ticket anulado</button>
          <!-- <button type="submit" class="btn btn-blue col-4 " onsubmit="modal1()"  data-toggle="modal" data-target="#modal1">Añadir ticket anulado</button> -->
          <a href="<?=base_url?>index.php?controller=hojaDiaria&action=insertTicketCompensacion" class="btn btn-success col-lg-5 ml-lg-4 ">No hay más anulaciones</a>
        </div>
      </div>
...
<div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="modalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="" action="<?=base_url?>index.php?controller=hojaDiaria&action=addTicketAnulado"  method="post">
        <div class="modal-body centrado">
          ...
          <input type="hidden" name="ticketAnulado" value="" id="codigo1">
        </div>
...
<!-- /Modal -->
      ...
      function modal1() {
        ...
        var importe = document.getElementById("ticketAnulado").value;
...
//Modal con el importe para poder verificar antes de enviar
        $('#modal1').modal('show');
        var valor = document.getElementById("ticketAnulado").value;
